...
namespace IgMarketsDataDownloader
{
    public class Program
    {
        ...
        private const string ServiceName = "IgMarketsDataDownloader";
        private const string ServiceDisplayName = "IG Markets Data Downloader Service";
        private const string ServiceDescription = "IG Markets Service running on .NET Core";
